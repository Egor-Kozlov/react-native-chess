...
import PassPlay from "./src/components/PassPlay";
  ...
  return (
    <NavigationContainer>
      <Stack.Navigator>
        ...
        />
        <Stack.Screen
          name={COMPONENTS_LIST.PassPlay}
          component={PassPlay}
          options={{ title: "Pass Play", headerTintColor: "black" }}
        />
        <Stack.Screen
          name={COMPONENTS_LIST.PassAFriend}
          component={PassPlay}
          options={{ title: "Play A Friend", headerTintColor: "black" }}
        />
        <Stack.Screen
          name={COMPONENTS_LIST.Settings}
          component={Settings}
        ...
        />
        <Stack.Screen
          name={COMPONENTS_LIST.PiecesStyle}
          component={PiecesStyle}
          options={{ title: "Pieces style", headerTintColor: "black" }}
        />
        <Stack.Screen
          name={COMPONENTS_LIST.BoardColors}
          component={BoardColors}
          options={{ title: "Board Colors", headerTintColor: "black" }}
        />
      </Stack.Navigator>
    </NavigationContainer>
  );
